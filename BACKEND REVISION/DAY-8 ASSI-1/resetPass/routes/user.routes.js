...
if(!user){
  ...
  let reserttoken =jwt.sign({ userId: user._id }, 'f715ff48dc9efbfd9b89180ffb7366de0c0646869e5a73cf7404751460b6abf3cfc240005c910d4c5b4ed4c77194b5d95a0601efb47d724aeb0f516287037a57', {
 expiresIn: '1h',
 });
 let resetLink = `http://localhost:3000/api/reset-pass?token=${reserttoken}`
 res.json({message:"password send to registerd email",link:resetLink})
}
})
